Crie um guia orientador sobre o poder que existe dentro do próprio ser humano, direcionado para profissionais que trabalham na maior parte do dia em home office.


Divida esse guia em 3 partes:



Identifique o nível de autoconhecimento da pessoa: Produza perguntas, com respostas de múltipla escolha sobre o conhecimento que ela tem sobre suas próprias habilidades, e de como ela se sente em relação a ela mesma. As resposta devem ser de opção check para marcar a opção desejada.
Aprofunde questões em nível da alma, mente e corpo.
